...
namespace EndlessCarChase
{
    ...
    public class ECCCar : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            Debug.Log("Nome dell'oggetto: " + gameObject.name);
            if (gameObject.name == "CustomCar(Clone)") { //Se l'oggetto è una custom car, allora assegna un flash_object per farlo flashare
        ...
        void Update()
        {
            ...
            else if (gameObject.name == "CustomCar(Clone)")
