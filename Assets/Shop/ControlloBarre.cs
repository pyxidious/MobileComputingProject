...
public class GestioneBarre : MonoBehaviour
{
    ...
    void TrovaOggetti()
    {
        ...
        GameObject nomeMacchinaObj = GameObject.Find("Canvas/Informazioni/Nome");
        ...
        prezzoMacchinaObj = GameObject.Find("Canvas/Informazioni/Costo");
        ...
        selected = GameObject.Find("Canvas/Select");

        locked = GameObject.Find("Canvas/Lock");

        GameObject healthbar = GameObject.Find("Canvas/Bars/Health/Full");
        healthbarImage = healthbar.GetComponent<Image>();

        GameObject speedbar = GameObject.Find("Canvas/Bars/Speed/Full");
        speedbarImage = speedbar.GetComponent<Image>();

        GameObject rotatebar = GameObject.Find("Canvas/Bars/RotateSpeed/Full");
        rotatebarImage = rotatebar.GetComponent<Image>();

        GameObject damagebar = GameObject.Find("Canvas/Bars/Damage/Full");
